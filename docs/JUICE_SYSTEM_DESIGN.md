...
@keyframes screen-shake {
  ...
  10% {
    transform: translate(calc(-1 * var(--shake-x)), var(--shake-y));
  }
  20% {
    transform: translate(var(--shake-x), calc(-1 * var(--shake-y)));
  }
  30% {
    transform: translate(calc(-0.5 * var(--shake-x)), var(--shake-y));
  }
  40% {
    transform: translate(var(--shake-x), var(--shake-y));
  }
  50% {
    transform: translate(calc(-1 * var(--shake-x)), calc(-0.5 * var(--shake-y)));
  }
  60% {
    transform: translate(var(--shake-x), calc(-1 * var(--shake-y)));
  }
